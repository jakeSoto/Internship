...
"""
Constraint: Requires about 3gb of free memory
CMD Usage: python -u "~C:\ filePath\of\ this\program\dataMiner.py~"
"""
...
def multiThread(data):
    ...
    for arr in data:
        thread = threading.Thread(target=runCellpose, args=(arr,))
